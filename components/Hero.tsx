  ...
  return (
    <div className="bg-inherit" id="hero">
      <motion.div>
        <div className="flex">
          <div className="flex flex-col justify-center text-left p-10 static items-start md:mx-10 my-11 md:basis-1/2 transition-all translate-y-5 duration-150">
            ...
            <p className="py-4 md:py-14 leading-normal tracking-wide text-gray-300">
              ...
              and technology. I'm extremely enthusiastic about design and
              carrying it through to completion. I'm a big fan of science and
              technology, so I strive to stay on top of things so that our
              consumers get the greatest experience possible.
            </p>
            <button
        ...
        <Image src={Wave} className="" alt="Wave" width="1450" height="400" />
      </motion.div>
    </div>
  );
};
